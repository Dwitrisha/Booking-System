...
function build_calendar($month,$year){
    ...
    */
    ...
    $calendar.="<a class='btn btn-xs btn-info' href='?month=".date('m')."&year=".date('Y')."'>Current Month </a>";
    ...
    while($currentDay<=$numberDays){
        ...
        if($dayname=='saturday'|| $dayname=='sunday'){
            ...
            if($totalbookings==36){
                ...
                $calendar.="<td class='$today'><h4>$currentDay</h4><a href='book.php?date=".$date."'class='btn btn-info btn-xs'>Book</a><small><i>$availableslots slots left</i></small>";
            }
